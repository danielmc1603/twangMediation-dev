...
\SweaveOpts{concordance=TRUE, prefix.string=t, split=TRUE, ae=FALSE, height=5, width=6}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% TITLE PAGE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
  \includegraphics[width=3.75in]{t-fig1plot}
\end{center}
...
\begin{center}
  \includegraphics[width=3.75in]{t-fig2plot}
\end{center}
...
\begin{center}
  \includegraphics[width=4in]{t-fig3plot}
\end{center}
...
\begin{center}
  \includegraphics[width=5in]{t-fig4plot}
\end{center}
...
\begin{center}
  \includegraphics[width=5in]{t-fig5plot}
\end{center}
